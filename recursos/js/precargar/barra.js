document.addEventListener("DOMContentLoaded", () => {
  ...
  const recursos = [
    ...
    basemedia + "cerveza/cerveza_corona.avif",
    basemedia + "cerveza/cerveza_heineken.avif",
    basemedia + "cerveza/cerveza_sol.avif",
    basemedia + "cerveza/cerveza_stella_artois.avif",
